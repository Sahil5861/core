...
<div class="slider-container">
  ...
  <section class="hero">
    ...
    <img src="{{asset('images/project/'.$details->image)}}" class="projectimg" alt="" >
  </section>
  <!-- start -->
  ...
  <section class="why-choose-us">
    <h2 style="text-align:center;color:white;font-size:38px;">Why Choose Us</h2>
    <div class="card-container">
      <div class="card">
        <div class="card-content">
          <div class="round-circle" style="background-color: #3C8CE7;">
            <i class="fa fa-history" aria-hidden="true" style="font-size:48px;"></i>
          </div>
          <h3 style="color:#1F2039">Experienced Team</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla dapibus justo et augue feugiat aliquam.</p>
        </div>
      </div>
      <div class="card">
        <div class="card-content">
          <div class="round-circle" style="background-color: #FFC371;">
            <i class="fa fa-star" aria-hidden="true" style="font-size:48px;"></i>

          </div>
          <h3 style="color:#1F2039">Quality Service</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla dapibus justo et augue feugiat aliquam.</p>
        </div>
      </div>
      <div class="card">
        <div class="card-content">
          <div class="round-circle" style="background-color: #81FBB8;">
            <i class="fa fa-heart" aria-hidden="true" style="font-size:48px;"></i>
          </div>
          <h3 style="color:#1F2039">Customer Satisfaction</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla dapibus justo et augue feugiat aliquam.</p>
        </div>  
      </div>
      <div class="card">
        <div class="card-content">
          <div class="round-circle" style="background-color: #FAB2FF;">
            <i class="fa fa-tag" aria-hidden="true" style="font-size:48px;"></i>
          </div>
          <h3 style="color:#1F2039">Affordable Prices</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla dapibus justo et augue feugiat aliquam.</p>
        </div>  
      </div>
    </div>
