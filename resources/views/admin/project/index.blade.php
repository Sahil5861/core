...
<div class="modal fade" id="add_blog_modal">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <form id="projectForm" method="post" action="{{route('saveProject')}}" enctype="multipart/form-data" novalidate>
            @csrf
            ...
            <div class="modal-body">
               <div class="row">
                  ...
                  @php
                   $technologies = \App\Models\Technology::pluck('name', 'id');
                  @endphp
                  <div class="col-sm-6 col-md-6 col-lg-6">
                     <div class="form-group">
                        <label for="app_type">Technology of Project*</label>
                        <select multiple class="form-control" required id="technologyproject" name="technologyproject[]" multiple>
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-6 ">
                     <div class="form-group">
                        ...
                        <select multiple class="form-control" required id="technology" name="technology[]">
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-6 ">
                     <div class="form-group">
                        ...
                        <select multiple class="form-control" required id="app_type" name="app_type[]">
...
<div class="modal fade" id="edit_blog_modal">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <form id="projectEditForm" method="post" action="{{route('saveProject')}}" enctype="multipart/form-data" novalidate>
            @csrf
            ...
            <div class="modal-body">
               <div class="row">
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-6">
                     <div class="form-group">
                        <label for="app_type">Technology of Project*</label>
                        <select multiple class="form-control" required id="techno" name="technologyproject[]" multiple>
                        @foreach ($technologies as $id => $technology)
                        <option value="{{ $technology }}">{{ $technology }}</option>
                      @endforeach
                        </select>
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-6 ">
                     <div class="form-group">
                        <label for="technology">Technology*</label>
                        <select multiple class="form-control" required id="technology1" name="technology[]">
                           <!-- <option value="">Select Technology</option> -->
                           @if(!empty($services))
                           @foreach($services as $service)
                           <option value="{{$service->title}}">{{$service->title}}</option>
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-6 ">
                     <div class="form-group">
                        <label for="app_type">App Type*</label>
                        <select multiple class="form-control" required id="app_type1" name="app_type[]">
                          <!-- <option value="">Select App Type</option> -->
                          <option value="App">App</option>
                          <option value="Web">Web</option>
                          <option value="Tv App">Tv App</option>
...
<script type="text/javascript">
   ...
   function view_item(id){
       let _url = "{{route('getProjectDetails')}}";
       ...
       $.ajax({
           ...
           success: function(response) {
               ...
               if(result.status){
                  ...
                  $('#techno').val(result.data.projectTechnology);
                  // alert(result.data.projectTechnology);
...
<script type="text/javascript">
   ...
   function multiple_del(){
      ...
      if(multicheck.length > 0){
         Swal.fire({
           title: 'Are you sure?',
           text: "Do you want to delete selected project!",
           icon: 'warning',
   ...
   function multiple_active(){
      ...
      if(multicheck.length > 0){
         Swal.fire({
           title: 'Are you sure?',
           text: "Do you want to make active selected project!",
           icon: 'warning',
           showCancelButton: true,
           confirmButtonColor: '#3085d6',
           cancelButtonColor: '#d33',
           ...
           if (result.isConfirmed) {
                $.ajax({
                    url: "{{route('project-multipleActive')}}",
                    method: 'post',
                    data: {ids: multicheck},
                })
                .done(function(obj) {
   ...
   function multiple_deactive(){
      ...
      if(multicheck.length > 0){
         Swal.fire({
           ...
           if (result.isConfirmed) {
              $.ajax({
                 url: "{{route('project-multipleDeactive')}}",
                 method: 'post',
                 data: {ids: multicheck},
              })
              .done(function(obj) {
