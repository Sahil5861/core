		...
		<div class="row gutter-y-60">
			<div class="col-lg-6">
				<div class="about-five__images">
					...
					<img src="{{asset('frontend/assets/images/resources/about.jpg')}}" class="wow fadeInUp image nature"
						data-wow-duration="1500ms" alt="" style="box-shadow: 0px 19px 38px rgba(0,0,0,0.30), 0 15px 12px rgba(0,0,0,0.22);border-radius:20px;">
			...
			<div class="col-lg-6">
				<div class="about-five__content">
					...
					<div class="about-five__text" style="font-size:18px;font-weight:600;">
					...
					<div class="about-four__meta">
						<div class="about-four__author">
							<img src="{{asset('frontend/assets/images/resources/ceo.jpg')}}" alt="" width="100px">
							<div class="about-four__author__content">
								<h3 class="about-four__author__title">Sadaam Hussain</h3>
...
<section
	...
	<div class="container">
		<div class="section-title text-center">
			...
			<h2 class="section-title__title">Best IT Solutions for Clients</h2>
			<!-- /.section-title__title -->
		</div><!-- /.section-title -->
...
<section class="section-padding--bottom section-padding--top testimonials-two background-repeat-no background-position-top-center"
					...
					<div class="row gutter-y-30">
						...
						<div class="col-lg-12">
							<div class="testimonials-one-card">
								<a href="{{ route('/client-detail', ['id' => $ClientData->id]) }}">
									<div class="testimonials-one-card__image">
										<img src="{{asset('images/project/'.$ClientData->logo)}}" alt=" " style="width:200px;">
			...
			<div class="col-lg-6">
				<div class="about-three__image">
					<img src="{{asset('frontend/assets/images/resources/company.jpg')}}" class="wow fadeInUp"
						data-wow-duration="1500ms" alt="" style="box-shadow:0px 29px 38px rgba(0,0,0,0.30),0 15px 12px rgba(0,0,0,0.22);border-radius:20px;">
			...
			<div class="col-lg-6">
				<div class="about-three__content">
					<div class="section-title ">
						...
						<h2 class="section-title__title">Why Choose Our Services?</h2><!-- /.section-title__title -->
					</div><!-- /.section-title -->
					<div class="about-three__text">Choose {{env('COMPANY_NAME')}} to have custom software solutions for your
...
<section class="section-padding--top section-padding--bottom">
	<div class="container">
		<div class="section-title text-center">
			...
			<h2 class="section-title__title">Latest News & Articles</h2><!-- /.section-title__title -->
		</div><!-- /.section-title -->
		<div class="row gutter-y-30">
    ...
    <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="0ms">
        <div class="blog-card-one">
            <div class="blog-card-one__image">
                <img src="{{ asset('images/blogs/' . $data->image) }}" alt="" width="500" height="200px">
                <a href="{{ route('blog_dt',['id' => $data->id] )}}"></a>
	...
	<div class="container">
		<div class="cta-one__inner text-center wow fadeInUp" data-wow-duration="1500ms">
			...
			<div class="section-title ">
				...
				<h2 class="section-title__title section-title__title--light">Let's Team Up on Your Project</h2>
				<!-- /.section-title__title -->
			</div><!-- /.section-title -->
