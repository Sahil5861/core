			...
			<div class="col-lg-3 col-md-6 col-sm-12">
				<div class="footer-widget footer-widget--about">
					<a href="index.html" class="footer-widget__logo">
						<img src="{{asset('frontend/assets/images/logo-light.png')}}" width="119" height="40" alt="Cretech">
					</a>
			...
			<div class="col-lg-3 col-md-6 col-sm-12">
				<div class="footer-widget footer-widget--links">
					...
					<ul class="footer-widget__links">
						<li>
							<a href="html/cretech/service-cyber-security.html">Cyber Security</a>
						</li>
						<li>
							<a href="html/cretech/service-it-management.html">IT Management</a>
						</li>
						<li>
							<a href="html/cretech/service-qa-testing.html">QA & Testing</a>
						</li>
						<li>
							<a href="html/cretech/service-infrastructure-plan.html">Infrastructure Plan</a>
						</li>
						<li>
							<a href="html/cretech/service-it-consultent.html">IT Consultent</a>
						</li>
				...
				<div class="footer-widget footer-widget--contact">
					...
					<ul class="footer-widget__contact">
						...
						<li>
							...
							Flat no 62 3rd floor, Pocket 25, <br> Sector 24, Rohini, Delhi 110085
						</li>
